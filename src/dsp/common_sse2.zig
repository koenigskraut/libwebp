...
pub inline fn VP8Transpose_2_4x4_16b(in0: *const __m128i, in1: *const __m128i, in2: *const __m128i, in3: *const __m128i, out0: *__m128i, out1: *__m128i, out2: *__m128i, out3: *__m128i) void {
    // Transpose the two 4x4.
    // a00 a01 a02 a03   b00 b01 b02 b03
    // a10 a11 a12 a13   b10 b11 b12 b13
    // a20 a21 a22 a23   b20 b21 b22 b23
    // a30 a31 a32 a33   b30 b31 b32 b33
    const transpose0_0 = webp._mm_unpacklo_epi16(in0.*, in1.*);
    const transpose0_1 = webp._mm_unpacklo_epi16(in2.*, in3.*);
    const transpose0_2 = webp._mm_unpackhi_epi16(in0.*, in1.*);
    const transpose0_3 = webp._mm_unpackhi_epi16(in2.*, in3.*);
    // a00 a10 a01 a11   a02 a12 a03 a13
    // a20 a30 a21 a31   a22 a32 a23 a33
    // b00 b10 b01 b11   b02 b12 b03 b13
    // b20 b30 b21 b31   b22 b32 b23 b33
    const transpose1_0 = webp._mm_unpacklo_epi32(transpose0_0, transpose0_1);
    const transpose1_1 = webp._mm_unpacklo_epi32(transpose0_2, transpose0_3);
    const transpose1_2 = webp._mm_unpackhi_epi32(transpose0_0, transpose0_1);
    const transpose1_3 = webp._mm_unpackhi_epi32(transpose0_2, transpose0_3);
    // a00 a10 a20 a30 a01 a11 a21 a31
    // b00 b10 b20 b30 b01 b11 b21 b31
    // a02 a12 a22 a32 a03 a13 a23 a33
    // b02 b12 a22 b32 b03 b13 b23 b33
    out0.* = webp._mm_unpacklo_epi64(transpose1_0, transpose1_1);
    out1.* = webp._mm_unpackhi_epi64(transpose1_0, transpose1_1);
    out2.* = webp._mm_unpacklo_epi64(transpose1_2, transpose1_3);
    out3.* = webp._mm_unpackhi_epi64(transpose1_2, transpose1_3);
